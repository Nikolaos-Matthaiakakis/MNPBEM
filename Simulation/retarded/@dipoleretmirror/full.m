...
%  Surface charges, potentials and electromagnetic field for full particle.
%
%  Usage for obj = dipoleretmirror :
%    [ val, p ] = full( obj, val )
%  Input
%    val    :  COMPSTRUCTMIRROR object containing surface charge or
...
%  transform vectors
for name = { 'e', 'h', 'h1', 'h2', 'a1', 'a1p', 'a2', 'a2p' }
  if isfield( vmean, name )
