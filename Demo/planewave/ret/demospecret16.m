%  DEMOSPECSTAT16 - Light scattering of nanodisk with mirror symmetry.
%    For a metallic nanodisk and an incoming plane wave with a polarization
%    along x and y, this program computes the scattering cross sections for
%    different light wavelengths from the full Maxwell equations.  The
%    simulations are performed with and without the use of mirror symmetry,
%    and the runtimes and results of the two approaches are compared.
%
%  Runtime on my computer:  160 sec.

%  options for BEM simulation with and w/o mirror symmetry
op1 = bemoptions( 'sim', 'ret', 'interp', 'curv', 'sym', 'xy', 'waitbar', 0 );
op2 = rmfield( op1, 'sym' );
...
%  end timer
fprintf( 1, 'CPU time bemretmirror: %8.2f\n', toc );
...
%  end timer
fprintf( 1, 'CPU time bemret:       %8.2f\n', toc );
